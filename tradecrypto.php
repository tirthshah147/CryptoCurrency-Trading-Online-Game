...
function slide(){
 ...
 <meta name="viewport" content="width=device-width, initial-scale=1.0">
    ...
    <link rel="stylesheet" type="text/css" href="tradecrypto2.css">
</head>
<body>
...
while($row=mysqli_fetch_assoc($result)){
   ...
   echo "<div id='name'>".$row['name']."</div>
     <div id='cryptobutton'>
<form action='buynsell.php' method='POST'>
	
<button name='submit' type='submit' value=".$row['name']." ".'style="'."background-image:url('".$row['imageuser']."')".'";'."></button>
</form>
</div>
